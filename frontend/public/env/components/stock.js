...
class Stock{
    ...
    input(event){
        ...
        if (this.state.creation){
            ...
            if (this.state.resizeInteraction.corner == "top" && !(this.state.flows.left != null && (event.x) - this.hyperCanvas.getFeature(this.state.flows.left).state.x1 < 100)){
                ...
                var tempA = Math.max(event.x - this.state.x, 50)
                if (!(this.state.flows.right != null && this.hyperCanvas.getFeature(this.state.flows.right).state.x2 - (this.state.x + tempA + event.x - this.state.prevInteraction.x) < 100)){
